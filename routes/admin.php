...
//                Route::get('app', 'LanguageController@index_app')->name('index-app');
            ...
            Route::group(['middleware'=>['module:web_&_app_settings']],function(){
                ...
                Route::get('warrenty-policy', 'BusinessSettingsController@warrenty_policy')->name('warrenty-policy');
                Route::post('warrenty-policy', 'BusinessSettingsController@warrenty_policyUpdate')->name('warrenty-update');
                
                Route::get('compliance-policy', 'BusinessSettingsController@compliance_policy')->name('compliance-policy');
                Route::post('compliance-policy', 'BusinessSettingsController@compliance_policyUpdate')->name('compliance-update');
                
                Route::get('code-of-conduct', 'BusinessSettingsController@code_of_conduct')->name('code-of-conduct');
                Route::post('code-of-conduct', 'BusinessSettingsController@code_of_conductUpdate')->name('code-of-conduct-update');

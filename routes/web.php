...
Route::group(['namespace' => 'Web','middleware'=>['maintenance_mode']], function () {
    ...
    Route::get('compliance-policy', 'WebController@compliance_policy')->name('compliance-policy');
    Route::get('code-of-conduct', 'WebController@code_of_conduct')->name('code-of-conduct');
    Route::get('restricted-brandlist', 'WebController@restricted_brandlist')->name('restricted-brandlist');
    Route::get('purchase-protection', 'WebController@purchase_protection')->name('purchase-protection');
    Route::get('product-guidelines-policy', 'WebController@product_guidelines_policy')->name('product-guidelines-policy');
    Route::get('non-returnable-items', 'WebController@non_returnable_items')->name('non-returnable-items');
    Route::get('fair-trade-policy', 'WebController@fair_trade_policy')->name('fair-trade-policy');
    Route::get('communication-guidelines', 'WebController@communication_guidelines')->name('communication-guidelines');
    Route::get('issuance-of-refunds', 'WebController@refund_policy')->name('refund-policy');

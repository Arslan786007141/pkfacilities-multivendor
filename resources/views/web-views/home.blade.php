...
@php($decimal_point_settings = \App\CPU\Helpers::get_business_settings('decimal_point_settings'))
    ...
    <div class="container mb-4">
        <div class="row" style="background: #ddfcc2;box-shadow: 0px 3px 6px #0000000d;border-radius: 5px;">
            <div class="col-md-12" >
...
@php($main_section_banner = \App\Model\Banner::where('banner_type','Main Section Banner')->where('published',1)->orderBy('id','desc')->latest()->first())
    ...
    <div class="container rtl mb-3" style="">
        <div class="col-md-12" style="background-color:#ddfcc2;padding:20px;border-radius:10px;">

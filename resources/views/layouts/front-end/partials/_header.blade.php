...
<header class="box-shadow-sm rtl">
    <!-- Topbar-->
    <div class="topbar" style="background:white">
        <div class="container">

            <div>
                <div class="topbar-text dropdown d-md-none {{Session::get('direction') === "rtl" ? 'mr-auto' : 'ml-auto'}}">
                    <a class="topbar-link" href="https://wa.me/+923090055826?text=" target="_blank">
                        <img src="{{asset('public/assets/front-end/img/watsapp-icon.png')}}" height="11px" width="14px" alt="watsapp-logo"> {{$web_config['phone']->value}}
                    </a>
                </div>
                <div class="d-none d-md-block {{Session::get('direction') === "rtl" ? 'mr-2' : 'ml-2'}} text-nowrap">
                    <a class="topbar-link d-none d-md-inline-block" href="https://wa.me/+923090055826?text=" target="_blank">
                        <img src="{{asset('public/assets/front-end/img/watsapp-icon.png')}}" height="11px" width="14px" alt="watsapp-logo"> {{$web_config['phone']->value}}
                    </a>
                </div>
            </div>
    ...
    <div class="navbar-sticky bg-light mobile-head">
                ...
                <div class="input-group-overlay d-none d-md-block mx-4"
                    ...
                    <form action="{{route('products')}}" type="submit" class="search_form">
                        ...
                        <button class="input-group-append-overlay search_button" type="submit"
                                style="border-radius: {{Session::get('direction') === "rtl" ? '7px 0px 0px 7px; right: unset; left: 0' : '0px 7px 7px 0px; left: unset; right: 0'}};top:0;background: #70B737;">
        ...
        <div class="navbar navbar-expand-md navbar-stuck-menu" style="background: #fff !important;" >
            <div class="container" style="padding-left: 10px;padding-right: 10px;">
                <div class="collapse navbar-collapse" id="navbarCollapse"
                    ...
                    <ul class="navbar-nav mega-nav pr-2 pl-2 {{Session::get('direction') === "rtl" ? 'ml-2' : 'mr-2'}} d-none d-xl-block " style="background: #70B737;
    border-radius: 20px">
                        <!--web-->
                        <li class="nav-item {{!request()->is('/')?'dropdown':''}}">
                            <a class="nav-link dropdown-toggle {{Session::get('direction') === "rtl" ? 'pr-0' : 'pl-0'}}"
                               href="#" data-toggle="dropdown" style="{{request()->is('/')?'pointer-events: none':''}}; color: black !important;">
                    ...
                    <ul class="navbar-nav" style="{{Session::get('direction') === "rtl" ? 'padding-right: 0px' : ''}}">
                        ...
                        <li class="nav-item dropdown {{request()->is('/')?'active':''}}">
                            <a class="nav-link" href="{{route('terms')}}">Term & Conditions</a>
                        </li>
                        ...
                        <li class="nav-item">
                                    <div class="dropdown">
                                        <button class="btn dropdown-toggle" type="button" id="dropdownMenuButton"
                                                ...
                                                style="margin-top: 5px; padding-{{Session::get('direction') === "rtl" ? 'right' : 'left'}}: 0">
                                            Marketplace
                                        </button>
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton"
                                            style="min-width: 165px !important; text-align: {{Session::get('direction') === "rtl" ? 'right' : 'left'}};">
                                            <a class="dropdown-item" href="{{route('warranty-policy')}}">
                                               Warranty Policy
                                            </a>
                                            <div class="dropdown-divider"></div>
                                            ...
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="{{route('product-guidelines-policy')}}">
                                                Product Guidelines Policy
                                            </a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="{{route('purchase-protection')}}">
                                                Purchase Protection
                                            </a>
                                            <div class="dropdown-divider"></div>
                                            <a class="dropdown-item" href="{{route('non-returnable-items')}}">

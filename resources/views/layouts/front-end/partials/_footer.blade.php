...
<footer class="page-footer font-small mdb-colorrtl" style="background: #70B737 !important;">
    <!-- Footer Links -->
            ...
            <div
                ...
                <div class="col-md-9" >
                    <div class="row">
                        ...
                        <div class="col-md-3 footer-padding-bottom" >
                            <h6 class="text-uppercase mb-4 font-weight-bold footer-heder">Seller Support</h6>
                            <ul class="widget-list" style="padding-bottom: 10px">
                                @php($flash_deals=\App\Model\FlashDeal::where(['status'=>1,'deal_type'=>'flash_deal'])->whereDate('start_date','<=',date('Y-m-d'))->whereDate('end_date','>=',date('Y-m-d'))->first())
                                @if(isset($flash_deals))
                                    <li class="widget-list-item">
                                ...
                                @endif
                                <li class="widget-list-item"><a class="widget-list-link"
                                                                href="{{route('compliance-policy')}}">Compliance Policy</a>
                                </li>
                                <li class="widget-list-item"><a class="widget-list-link"
                                                                href="{{route('code-of-conduct')}}">Code of Conduct</a>
                                </li>
                                <li class="widget-list-item"><a class="widget-list-link"
                                                                href="{{route('fair-trade-policy')}}">Fair Trade Policy</a>
                                </li>
                                <li class="widget-list-item"><a class="widget-list-link"
                                                                href="{{route('restricted-brandlist')}}">Restricted Brandlist</a>
                                </li>
                                <li class="widget-list-item"><a class="widget-list-link"
                                                                href="{{route('communication-guidelines')}}">Communication Guidelines</a>
                                </li>
                            ...
                            <div class="row ">
                                <div class="col-11 start_address ">
                                    <div style="color:" class="">
                                        <a class="widget-list-link" href="tel: 0685875826">
                                            <span ><i class="fa fa-phone m-2"></i>068-5875826 </span>
                                        </a>

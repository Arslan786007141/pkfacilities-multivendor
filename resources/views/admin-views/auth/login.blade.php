...
<main id="content" role="main" class="main">
    ...
    <div class="container py-5 py-sm-7">
        <label class="badge badge-soft-success float-right" style="display: none;z-index: 9;position: absolute;right: 0.5rem;top: 0.5rem;">{{\App\CPU\translate('Software version')}} : {{ env('SOFTWARE_VERSION') }}</label>

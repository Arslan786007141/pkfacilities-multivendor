...
class WebController extends Controller
{
    ...
    {
        $warranty_policy = BusinessSetting::where('type', 'warrenty_policy')->first();
        return view('web-views.warrenty-policy', compact('warranty_policy'));
    }
    
    public function compliance_policy()
    {
        $compliance_policy = BusinessSetting::where('type', 'compliance_policy')->first();
        return view('web-views.compliance-policy', compact('compliance_policy'));
    }
    
    public function code_of_conduct()
    {
        $code_of_conduct = BusinessSetting::where('type', 'code_of_conduct')->first();
        return view('web-views.code-of-conduct', compact('code_of_conduct'));
    }
    
    public function restricted_brandlist()
    {
        $restricted_brandlist = BusinessSetting::where('type', 'restricted_brandlist')->first();
        return view('web-views.restricted-brandlist', compact('restricted_brandlist'));
    }
    
    public function purchase_protection()
    {
        $purchase_protection = BusinessSetting::where('type', 'purchase_protection')->first();
        return view('web-views.purchase-protection', compact('purchase_protection'));
    }
    
    public function product_guidelines_policy()
    {
        $product_guidelines_policy = BusinessSetting::where('type', 'product_guidelines_policy')->first();
        return view('web-views.product-guidelines-policy', compact('product_guidelines_policy'));
    }
    
    public function non_returnable_items()
    {
        $non_returnable_items = BusinessSetting::where('type', 'non_returnable_items')->first();
        return view('web-views.non-returnable-items', compact('non_returnable_items'));
    }
    
    public function fair_trade_policy()
    {
        $fair_trade_policy = BusinessSetting::where('type', 'fair_trade_policy')->first();
        return view('web-views.fair-trade-policy', compact('fair_trade_policy'));
    }
    
    public function communication_guidelines()
    {
        $communication_guidelines = BusinessSetting::where('type', 'communication_guidelines')->first();
        return view('web-views.communication-guidelines', compact('communication_guidelines'));
    }
    
    public function refund_policy()
    {
        $refund_policy = BusinessSetting::where('type', 'refund_policy')->first();

...
class BusinessSettingsController extends Controller
{
    ...
    {
        $warrenty_policy = BusinessSetting::where('type', 'warrenty_policy')->first();
        return view('admin-views.business-settings.warrenty-policy', [
            'warrenty_policy' => $warrenty_policy,
        ]);
    }
    
    public function warrenty_policyUpdate(Request $request)
    {
        $validatedData = $request->validate([
            'warrenty_policy' => 'required',
        ]);
        BusinessSetting::where('type', 'warrenty_policy')->update(['value' => $request->warrenty_policy]);
        Toastr::success('Warrenty Policy updated successfully!');
        return back();
    }
    ...
    public function compliance_policy()
    {
        ...
        return view('admin-views.business-settings.compliance-policy', [
            'compliance_policy' => $compliance_policy,
        ]);
    }
    
    public function compliance_policyUpdate(Request $request)
    {
        $validatedData = $request->validate([
            'compliance_policy' => 'required',
        ]);
        BusinessSetting::where('type', 'compliance_policy')->update(['value' => $request->compliance_policy]);
        Toastr::success('Seller Compliance Policy updated successfully!');
        return back();
    }
    ...
    public function code_of_conduct()
    {
        ...
        return view('admin-views.business-settings.code-of-conduct', [
            'code_of_conduct' => $code_of_conduct,
        ]);
    }
    
    public function code_of_conductUpdate(Request $request)
    {
        $validatedData = $request->validate([
            'code_of_conduct' => 'required',
        ]);
        BusinessSetting::where('type', 'code_of_conduct')->update(['value' => $request->code_of_conduct]);
        Toastr::success('Seller Code Of Conduct updated successfully!');
        return back();
    }
